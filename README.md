...
With this repository, *TIB - Leibniz Information Centre for Science and Technology University Library* provides a practical guide for metadata management of ontologies. It gives recommendations on required, recommended and optional metadata for ontologies as well as ontology entities, i.e. classes, properties and individuals.
...
One set of SHACL specifications is for ontology-level metadata.
These serve three different applications as documented below.
The target class of these shapes is owl:Ontology, so that they can only be used to validate entities that declare themselves as an instance of owl:Ontology, and also code generated with these shapes, will declare entities as instances of owl:Ontology.

The other set of SHACL specifcations is for term-level metadata targeting instances of owl:Class, owl:NamedIndividual, owl:ObjectProperty, owl:AnnotationProperty and owl:DatatypeProperty.

This repository is archived at Zenodo: <https://doi.org/10.5281/zenodo.11103070>
...
The shapes for term-level metadata also serve two purposes:

* [TermShape.ttl](/TermShape.ttl) is for data validation
* [TermShape4Forms.ttl](TermShape4Forms.ttl) is for metadata code generation,

cf. [Section 2.2.2 in the Metadata Guide](MetadataGuide.md#222-term-level-metadata) for details.

## Contributions

If you would like to leave feedback, visit our [issue tracker](https://github.com/TIBHannover/terminology-metadata/issues). If you want to comment on any partiuclar shapes, you can join the [discussions on the metadata shapes](https://github.com/TIBHannover/terminology-metadata/issues?q=is%3Aissue%20state%3Aopen%20label%3Adiscussion-issue).
We do not recommend contributing directly to the code base of the repository, since update processes are not well automated and a lot of cross-references need to be checked.
If you still want to try, you are welcome, but pull requests may not be immediate.
